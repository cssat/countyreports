...
data_through_date <- sqlQuery(con, "select * from ref_last_dw_transfer")[1, 1] ## TODO build other dates off of this one
last_complete <- list()
...
## TODO make date automated in queries
...
hl_names <- c("\\textbf{U.S. Census Bureau (2012)}", 
              ...
              "\\textbf{Child Well-Being Data Portal (First Day of 2013)}",
