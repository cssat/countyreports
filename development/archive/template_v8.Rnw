...
read_chunk('county_reports_v8.R')
...
%\vspace{-1.8in}
\textbf{Selected data highlights for \Sexpr{display_county} County:}
...
\begin{center}
\includegraphics[width=2.7in]{county_maps/\Sexpr{display_county}-b}
\end{center}
...
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in investigations \& assessments for the DCFS office(s)/office group(s) in \Sexpr{display_county} County.  
\nopagebreak[2]
...
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in in-home services for the DCFS offices in \Sexpr{display_county} County. 
\nopagebreak[3]
