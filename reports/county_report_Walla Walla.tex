...
\lhead{\color{pocDGreen} Walla Walla County Report}
...
\begin{tikzpicture}[x=1in, y=1in]
    ...
    \node[right = 6pt, white] at (0, \banY - \stripeYpos - \stripeHeight + 16pt)
        {\fontspec{Archer}\Huge{Focus on Walla Walla County}};
    
    %% Below Stripe Text
    \node[below right = 6pt, pocDBlue, align = left, text width = \textwidth - 12pt]
        at (0, \banY - \stripeYpos - \stripeHeight) {
         This \emph{Focus on Walla Walla County} report is one of a series of automated county reports for Washington State. These quarterly reports mirror the Child Well-Being Data Portal by providing information on three major parts of the child welfare system: Investigations \& Assessments, In-Home Services, and Out-of-Home Care. To access the Data Portal and the latest county reports, visit \href{http://www.partnersforourchildren.org/child-well-being}{www.partnersforourchildren.org/child-well-being}.} ;  
\end{tikzpicture}
...
\section*{Overview}
\vspace{-6pt}
The Department of Social and Health Services (DSHS) divides Washington State into three regions. Walla Walla County is in Region~1, along with Adams, Asotin, Benton, Chelan, Columbia, Douglas, Ferry, Franklin, Garfield, Grant, Kittitas, Klickitat, Lincoln, Okanogan, Pend Oreille, Spokane, Stevens, Whitman and Yakima counties. The following report includes basic graphs and tables for Investigations \& Assessments, In-Home Services and Out-of-Home Care in Walla Walla County}.
...
We hope this report serves as a valuable tool for  Walla Walla County.

\begin{minipage}{0.6\textwidth}
%\vspace{-1.8in}
\textbf{Data highlights for Walla Walla County:}

% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:44:18 2013
\begin{tabular}{lr}
  \toprule
 \textbf{U.S. Census Bureau (2012)} &  \\ 
  \quad Total Population & 59,404 \\ 
  \quad Percent of Population Under 5 Years & 5.9\% \\ 
  \quad Percent of Population Under 18 Years & 22.3\% \\ 
  \textbf{Child Well-Being Data Portal (April 01, 2013)} &  \\ 
  \quad Number of Open Investigations \& Assessments & 295 \\ 
  \quad Number of Open In-Home Service Cases & 62 \\ 
  \quad Number of Open Out-of-Home Care Cases & 96 \\ 
  \quad Percent of Out-of-Home Care Cases: Children Under 5 Years & 34\% \\ 
   \bottomrule
\end{tabular}
...
\begin{center}
\includegraphics[width=2.7in]{county_maps/Walla_Walla-b}
\end{center}
...
{Investigations \& Assessments:} Walla Walla County Focus}
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in investigations \& assessments cases for the DCFS office(s)/office group(s) in Walla Walla County.  
\begin{knitrout}
...
\subsection{\href{http://www.partnersforourchildren.org/child-well-being/visualizations/home-services/trends}
    {In-Home Services: Walla Walla County Focus}
}
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in in-home services cases for the DCFS offices in Walla Walla County. 
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
The following bar graph shows the percentage of children in the 2010 entry cohort (those who entered at the same time in 2010) achieving each outcome for Walla Walla County, Region~1 and Washington State.
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
The table below provides relevant U.S. Census Bureau data for Walla Walla County and for Washington State. 
\nopagebreak[3]
% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:44:20 2013
\begin{table}[ht]
\centering
\caption{Walla Walla County Summary} 
\begin{tabular}{lrr}
  \toprule
 & Walla Walla County & Washington \\ 
  \midrule
Total population (2012) & 59,404 & 6,897,012 \\ 
  Percent change in population (2010 to 2012) & 1.1\% & 2.6\% \\ 
  Population under 5 years & 5.9\% & 6.5\% \\ 
  Population under 18 years & 22.3\% & 23.2\% \\ 
  Population: White alone & 92.4\% & 82.0\% \\ 
  Population: Black alone & 2.0\% & 3.8\% \\ 
  Population: American Indian/Alaska Native alone & 1.3\% & 1.8\% \\ 
  Population: Asian alone & 1.5\% & 7.5\% \\ 
  Population: Native Hawaiian/Other Pacific Islander alone & 0.3\% & 0.7\% \\ 
  Population: Multiracial & 2.4\% & 4.3\% \\ 
  Population: Hispanic or Latino Origin & 20.3\% & 11.6\% \\ 
  Population: Not Hispanic, White alone & 73.5\% & 72.1\% \\ 
  Education: High school graduate (age $>$25) & 87.1\% & 89.8\% \\ 
  People below poverty line (all ages) & 18.2\% & 12.5\% \\ 
  Population per square mile & 46.3 & 101.2 \\ 
   \bottomrule
\end{tabular}
\end{table}
