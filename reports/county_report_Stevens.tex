...
\lhead{\color{pocDGreen} Stevens County Report}
...
\begin{tikzpicture}[x=1in, y=1in]
    ...
    \node[right = 6pt, white] at (0, \banY - \stripeYpos - \stripeHeight + 16pt)
        {\fontspec{Archer}\Huge{Focus on Stevens County}};
    
    %% Below Stripe Text
    \node[below right = 6pt, pocDBlue, align = left, text width = \textwidth - 12pt]
        at (0, \banY - \stripeYpos - \stripeHeight) {
         This \emph{Focus on Stevens County} report is one of a series of automated county reports for Washington State. These quarterly reports mirror the Child Well-Being Data Portal by providing information on three major parts of the child welfare system: Investigations \& Assessments, In-Home Services, and Out-of-Home Care. To access the Data Portal and the latest county reports, visit \href{http://www.partnersforourchildren.org/child-well-being}{www.partnersforourchildren.org/child-well-being}.} ;  
\end{tikzpicture}
...
\section*{Overview}
\vspace{-6pt}
The Department of Social and Health Services (DSHS) divides Washington State into three regions. Stevens County is in Region~1, along with Adams, Asotin, Benton, Chelan, Columbia, Douglas, Ferry, Franklin, Garfield, Grant, Kittitas, Klickitat, Lincoln, Okanogan, Pend Oreille, Spokane, Walla Walla, Whitman and Yakima counties. The following report includes basic graphs and tables for Investigations \& Assessments, In-Home Services and Out-of-Home Care in Stevens County}.
...
We hope this report serves as a valuable tool for  Stevens County.

\begin{minipage}{0.6\textwidth}
%\vspace{-1.8in}
\textbf{Data highlights for Stevens County:}

% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:43:20 2013
\begin{tabular}{lr}
  \toprule
 \textbf{U.S. Census Bureau (2012)} &  \\ 
  \quad Total Population & 43,538 \\ 
  \quad Percent of Population Under 5 Years & 5.2\% \\ 
  \quad Percent of Population Under 18 Years & 23.2\% \\ 
  \textbf{Child Well-Being Data Portal (April 01, 2013)} &  \\ 
  \quad Number of Open Investigations \& Assessments & 4 \\ 
  \quad Number of Open In-Home Service Cases & 18 \\ 
  \quad Number of Open Out-of-Home Care Cases & 106 \\ 
...
\begin{center}
\includegraphics[width=2.7in]{county_maps/Stevens-b}
\end{center}
...
{Investigations \& Assessments:} Stevens County Focus}
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in investigations \& assessments cases for the DCFS office(s)/office group(s) in Stevens County.  
\begin{knitrout}
...
\subsection{\href{http://www.partnersforourchildren.org/child-well-being/visualizations/home-services/trends}
    {In-Home Services: Stevens County Focus}
}
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in in-home services cases for the DCFS offices in Stevens County. 
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
\subsection{\href{http://www.partnersforourchildren.org/child-well-being/visualizations/out-home-care/trends}
 {Out-of-Home Care: Stevens County Focus}
}
...
The following bar graph shows the percentage of children in the 2010 entry cohort (those who entered at the same time in 2010) achieving each outcome for Stevens County, Region~1 and Washington State.
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
The table below provides relevant U.S. Census Bureau data for Stevens County and for Washington State. 
\nopagebreak[3]
% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:43:22 2013
\begin{table}[ht]
\centering
\caption{Stevens County Summary} 
\begin{tabular}{lrr}
  \toprule
 & Stevens County & Washington \\ 
  \midrule
Total population (2012) & 43,538 & 6,897,012 \\ 
  Percent change in population (2010 to 2012) & 0.0\% & 2.6\% \\ 
  Population under 5 years & 5.2\% & 6.5\% \\ 
  Population under 18 years & 23.2\% & 23.2\% \\ 
  Population: White alone & 90.1\% & 82.0\% \\ 
  Population: Black alone & 0.4\% & 3.8\% \\ 
  Population: American Indian/Alaska Native alone & 5.5\% & 1.8\% \\ 
  ...
  Population: Not Hispanic, White alone & 87.8\% & 72.1\% \\ 
  Education: High school graduate (age $>$25) & 90.3\% & 89.8\% \\ 
  People below poverty line (all ages) & 16.1\% & 12.5\% \\ 
  Population per square mile & 17.6 & 101.2 \\ 
   \bottomrule
\end{tabular}
\end{table}
