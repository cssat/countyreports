...
\lhead{\color{pocDGreen} Clark County Report}
...
\begin{tikzpicture}[x=1in, y=1in]
    ...
    \node[right = 6pt, white] at (0, \banY - \stripeYpos - \stripeHeight + 16pt)
        {\fontspec{Archer}\Huge{Focus on Clark County}};
    
    %% Below Stripe Text
    \node[below right = 6pt, pocDBlue, align = left, text width = \textwidth - 12pt]
        at (0, \banY - \stripeYpos - \stripeHeight) {
         This \emph{Focus on Clark County} report is one of a series of automated county reports for Washington State. These quarterly reports mirror the Child Well-Being Data Portal by providing information on three major parts of the child welfare system: Investigations \& Assessments, In-Home Services, and Out-of-Home Care. To access the Data Portal and the latest county reports, visit \href{http://www.partnersforourchildren.org/child-well-being}{www.partnersforourchildren.org/child-well-being}.} ;  
\end{tikzpicture}
...
We hope this report serves as a valuable tool for  Clark County.

\begin{minipage}{0.6\textwidth}
%\vspace{-1.8in}
\textbf{Data highlights for Clark County:}

% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:32:39 2013
\begin{tabular}{lr}
  \toprule
 \textbf{U.S. Census Bureau (2012)} &  \\ 
  \quad Total Population & 438,287 \\ 
  \quad Percent of Population Under 5 Years & 6.7\% \\ 
  \quad Percent of Population Under 18 Years & 26.0\% \\ 
  \textbf{Child Well-Being Data Portal (April 01, 2013)} &  \\ 
  \quad Number of Open Investigations \& Assessments & 379 \\ 
  \quad Number of Open In-Home Service Cases & 75 \\ 
  \quad Number of Open Out-of-Home Care Cases & 603 \\ 
  \quad Percent of Out-of-Home Care Cases: Children Under 5 Years & 46\% \\ 
   \bottomrule
\end{tabular}
...
\begin{center}
\includegraphics[width=2.7in]{county_maps/Clark-b}
\end{center}
...
{Investigations \& Assessments:} Clark County Focus}
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in investigations \& assessments cases for the DCFS office(s)/office group(s) in Clark County.  
\begin{knitrout}
...
\subsection{\href{http://www.partnersforourchildren.org/child-well-being/visualizations/home-services/trends}
    {In-Home Services: Clark County Focus}
}
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in in-home services cases for the DCFS offices in Clark County. 
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
\subsection{\href{http://www.partnersforourchildren.org/child-well-being/visualizations/out-home-care/trends}
 {Out-of-Home Care: Clark County Focus}
}
...
The following bar graph shows the percentage of children in the 2010 entry cohort (those who entered at the same time in 2010) achieving each outcome for Clark County, Region~3 and Washington State.
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
The table below provides relevant U.S. Census Bureau data for Clark County and for Washington State. 
\nopagebreak[3]
% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:32:41 2013
\begin{table}[ht]
\centering
\caption{Clark County Summary} 
\begin{tabular}{lrr}
  \toprule
 & Clark County & Washington \\ 
  \midrule
Total population (2012) & 438,287 & 6,897,012 \\ 
  Percent change in population (2010 to 2012) & 3.0\% & 2.6\% \\ 
  Population under 5 years & 6.7\% & 6.5\% \\ 
  Population under 18 years & 26.0\% & 23.2\% \\ 
  Population: White alone & 88.1\% & 82.0\% \\ 
  Population: Black alone & 2.1\% & 3.8\% \\ 
  Population: American Indian/Alaska Native alone & 1.0\% & 1.8\% \\ 
  Population: Asian alone & 4.3\% & 7.5\% \\ 
  Population: Native Hawaiian/Other Pacific Islander alone & 0.7\% & 0.7\% \\ 
  Population: Multiracial & 3.8\% & 4.3\% \\ 
  Population: Hispanic or Latino Origin & 7.8\% & 11.6\% \\ 
  Population: Not Hispanic, White alone & 81.4\% & 72.1\% \\ 
  Education: High school graduate (age $>$25) & 90.8\% & 89.8\% \\ 
  People below poverty line (all ages) & 11.7\% & 12.5\% \\ 
  Population per square mile & 676.2 & 101.2 \\ 
   \bottomrule
\end{tabular}
\end{table}
