...
if (db == "test") data_through_date <- sqlQuery(con, "select * from ref_last_dw_transfer")[1, 1] ## TODO build other dates off of this one
...
## Highlights
hl_date <- as.POSIXlt(ymd("2012-10-01"))
