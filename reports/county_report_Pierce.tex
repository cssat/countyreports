...
\begin{tikzpicture}[x=1in, y=1in]
    ...
    \node[below right = 6pt, pocDBlue, align = left, text width = \textwidth - 12pt]
        at (0, \banY - \stripeYpos - \stripeHeight) {
         This \emph{Focus on Pierce County} report is one of a series of automated county reports for Washington State. These quarterly reports mirror the Child Well-Being Data Portal by providing information on three major parts of the child welfare system: Investigations \& Assessments, In-Home Services, and Out-of-Home Care. To access the Data Portal and the latest county reports, visit \href{http://www.partnersforourchildren.org/child-well-being}{www.partnersforourchildren.org/child-well-being}.} ;  
\end{tikzpicture}
...
\section*{Overview}
\vspace{-6pt}
The Department of Social and Health Services (DSHS) divides Washington State into three regions. Pierce County is in Region~3, along with Clallam, Clark, Cowlitz, Grays Harbor, Jefferson, Kitsap, Lewis, Mason, Pacific, Skamania, Thurston and Wahkiakum counties. The following report includes basic graphs and tables for Investigations \& Assessments, In-Home Services and Out-of-Home Care in Pierce County}.
...
We hope this report serves as a valuable tool for  Pierce County.

\begin{minipage}{0.6\textwidth}
%\vspace{-1.8in}
\textbf{Data highlights for Pierce County:}

% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:41:23 2013
\begin{tabular}{lr}
  \toprule
 \textbf{U.S. Census Bureau (2012)} &  \\ 
  \quad Total Population & 811,681 \\ 
  \quad Percent of Population Under 5 Years & 6.9\% \\ 
  \quad Percent of Population Under 18 Years & 24.3\% \\ 
  \textbf{Child Well-Being Data Portal (April 01, 2013)} &  \\ 
  \quad Number of Open Investigations \& Assessments & 811 \\ 
  \quad Number of Open In-Home Service Cases & 138 \\ 
  \quad Number of Open Out-of-Home Care Cases & 1,766 \\ 
...
\begin{center}
\includegraphics[width=2.7in]{county_maps/Pierce-b}
\end{center}
...
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in investigations \& assessments cases for the DCFS office(s)/office group(s) in Pierce County.  
\begin{knitrout}
...
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in in-home services cases for the DCFS offices in Pierce County. 
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
The following bar graph shows the percentage of children in the 2010 entry cohort (those who entered at the same time in 2010) achieving each outcome for Pierce County, Region~3 and Washington State.
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
The table below provides relevant U.S. Census Bureau data for Pierce County and for Washington State. 
\nopagebreak[3]
% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:41:26 2013
\begin{table}[ht]
\centering
