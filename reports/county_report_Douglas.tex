...
\lhead{\color{pocDGreen} Douglas County Report}
...
\begin{tikzpicture}[x=1in, y=1in]
    ...
    \node[right = 6pt, white] at (0, \banY - \stripeYpos - \stripeHeight + 16pt)
        {\fontspec{Archer}\Huge{Focus on Douglas County}};
    
    %% Below Stripe Text
    \node[below right = 6pt, pocDBlue, align = left, text width = \textwidth - 12pt]
        at (0, \banY - \stripeYpos - \stripeHeight) {
         This \emph{Focus on Douglas County} report is one of a series of automated county reports for Washington State. These quarterly reports mirror the Child Well-Being Data Portal by providing information on three major parts of the child welfare system: Investigations \& Assessments, In-Home Services, and Out-of-Home Care. To access the Data Portal and the latest county reports, visit \href{http://www.partnersforourchildren.org/child-well-being}{www.partnersforourchildren.org/child-well-being}.} ;  
\end{tikzpicture}
...
\section*{Overview}
\vspace{-6pt}
The Department of Social and Health Services (DSHS) divides Washington State into three regions. Douglas County is in Region~1, along with Adams, Asotin, Benton, Chelan, Columbia, Ferry, Franklin, Garfield, Grant, Kittitas, Klickitat, Lincoln, Okanogan, Pend Oreille, Spokane, Stevens, Walla Walla, Whitman and Yakima counties. The following report includes basic graphs and tables for Investigations \& Assessments, In-Home Services and Out-of-Home Care in Douglas County}.
...
We hope this report serves as a valuable tool for  Douglas County.

\begin{minipage}{0.6\textwidth}
%\vspace{-1.8in}
\textbf{Data highlights for Douglas County:}

% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:33:37 2013
\begin{tabular}{lr}
  \toprule
 \textbf{U.S. Census Bureau (2012)} &  \\ 
  \quad Total Population & 39,350 \\ 
  \quad Percent of Population Under 5 Years & 7.2\% \\ 
...
\begin{center}
\includegraphics[width=2.7in]{county_maps/Douglas-b}
\end{center}
...
{Investigations \& Assessments:} Douglas County Focus}
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in investigations \& assessments cases for the DCFS office(s)/office group(s) in Douglas County.  
\begin{knitrout}
...
\subsection{\href{http://www.partnersforourchildren.org/child-well-being/visualizations/home-services/trends}
    {In-Home Services: Douglas County Focus}
}
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in in-home services cases for the DCFS offices in Douglas County. 
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
\subsection{\href{http://www.partnersforourchildren.org/child-well-being/visualizations/out-home-care/trends}
 {Out-of-Home Care: Douglas County Focus}
}
...
The following bar graph shows the percentage of children in the 2010 entry cohort (those who entered at the same time in 2010) achieving each outcome for Douglas County, Region~1 and Washington State.
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
The table below provides relevant U.S. Census Bureau data for Douglas County and for Washington State. 
\nopagebreak[3]
% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:33:39 2013
\begin{table}[ht]
\centering
\caption{Douglas County Summary} 
\begin{tabular}{lrr}
  \toprule
 & Douglas County & Washington \\ 
  \midrule
Total population (2012) & 39,350 & 6,897,012 \\ 
  Percent change in population (2010 to 2012) & 2.4\% & 2.6\% \\ 
  Population under 5 years & 7.2\% & 6.5\% \\ 
  Population under 18 years & 26.7\% & 23.2\% \\ 
  Population: White alone & 94.1\% & 82.0\% \\ 
  ...
  Population: Hispanic or Latino Origin & 28.9\% & 11.6\% \\ 
  Population: Not Hispanic, White alone & 67.4\% & 72.1\% \\ 
  Education: High school graduate (age $>$25) & 80.1\% & 89.8\% \\ 
  People below poverty line (all ages) & 16.7\% & 12.5\% \\ 
  Population per square mile & 21.1 & 101.2 \\ 
   \bottomrule
\end{tabular}
\end{table}
