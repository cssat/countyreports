...
The Investigations \& Assessments section (page \pageref{p:ia}) provides household data on, respectively, the total number of investigations and assessments cases since \Sexpr{year(ihs_start_date)}, as well as comparative rates for investigations and assessments cases for all Region~\Sexpr{region_cd} counties.
