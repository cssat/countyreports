...
\lhead{\color{pocDGreen} Whitman County Report}
...
\begin{tikzpicture}[x=1in, y=1in]
    ...
    \node[right = 6pt, white] at (0, \banY - \stripeYpos - \stripeHeight + 16pt)
        {\fontspec{Archer}\Huge{Focus on Whitman County}};
    
    %% Below Stripe Text
    \node[below right = 6pt, pocDBlue, align = left, text width = \textwidth - 12pt]
        at (0, \banY - \stripeYpos - \stripeHeight) {
         This \emph{Focus on Whitman County} report is one of a series of automated county reports for Washington State. These quarterly reports mirror the Child Well-Being Data Portal by providing information on three major parts of the child welfare system: Investigations \& Assessments, In-Home Services, and Out-of-Home Care. To access the Data Portal and the latest county reports, visit \href{http://www.partnersforourchildren.org/child-well-being}{www.partnersforourchildren.org/child-well-being}.} ;  
\end{tikzpicture}
...
\section*{Overview}
\vspace{-6pt}
The Department of Social and Health Services (DSHS) divides Washington State into three regions. Whitman County is in Region~1, along with Adams, Asotin, Benton, Chelan, Columbia, Douglas, Ferry, Franklin, Garfield, Grant, Kittitas, Klickitat, Lincoln, Okanogan, Pend Oreille, Spokane, Stevens, Walla Walla and Yakima counties. The following report includes basic graphs and tables for Investigations \& Assessments, In-Home Services and Out-of-Home Care in Whitman County}.
...
We hope this report serves as a valuable tool for  Whitman County.

\begin{minipage}{0.6\textwidth}
%\vspace{-1.8in}
\textbf{Data highlights for Whitman County:}

% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:45:16 2013
\begin{tabular}{lr}
  \toprule
 \textbf{U.S. Census Bureau (2012)} &  \\ 
  \quad Total Population & 46,606 \\ 
  \quad Percent of Population Under 5 Years & 4.4\% \\ 
  \quad Percent of Population Under 18 Years & 14.4\% \\ 
  \textbf{Child Well-Being Data Portal (April 01, 2013)} &  \\ 
  \quad Number of Open Investigations \& Assessments & 4 \\ 
  \quad Number of Open In-Home Service Cases & 5 \\ 
  \quad Number of Open Out-of-Home Care Cases & 48 \\ 
  \quad Percent of Out-of-Home Care Cases: Children Under 5 Years & 42\% \\ 
   \bottomrule
\end{tabular}
...
\begin{center}
\includegraphics[width=2.7in]{county_maps/Whitman-b}
\end{center}
...
{Investigations \& Assessments:} Whitman County Focus}
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in investigations \& assessments cases for the DCFS office(s)/office group(s) in Whitman County.  
\begin{knitrout}
...
\subsection{\href{http://www.partnersforourchildren.org/child-well-being/visualizations/home-services/trends}
    {In-Home Services: Whitman County Focus}
}
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in in-home services cases for the DCFS offices in Whitman County. 
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
\subsection{\href{http://www.partnersforourchildren.org/child-well-being/visualizations/out-home-care/trends}
 {Out-of-Home Care: Whitman County Focus}
}
...
The following bar graph shows the percentage of children in the 2010 entry cohort (those who entered at the same time in 2010) achieving each outcome for Whitman County, Region~1 and Washington State.
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
The table below provides relevant U.S. Census Bureau data for Whitman County and for Washington State. 
\nopagebreak[3]
% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:45:17 2013
\begin{table}[ht]
\centering
\caption{Whitman County Summary} 
\begin{tabular}{lrr}
  \toprule
 & Whitman County & Washington \\ 
  \midrule
Total population (2012) & 46,606 & 6,897,012 \\ 
  Percent change in population (2010 to 2012) & 4.1\% & 2.6\% \\ 
  Population under 5 years & 4.4\% & 6.5\% \\ 
  Population under 18 years & 14.4\% & 23.2\% \\ 
  Population: White alone & 85.4\% & 82.0\% \\ 
  Population: Black alone & 1.9\% & 3.8\% \\ 
  Population: American Indian/Alaska Native alone & 0.8\% & 1.8\% \\ 
  Population: Asian alone & 7.9\% & 7.5\% \\ 
  Population: Native Hawaiian/Other Pacific Islander alone & 0.3\% & 0.7\% \\ 
  Population: Multiracial & 3.7\% & 4.3\% \\ 
  Population: Hispanic or Latino Origin & 4.9\% & 11.6\% \\ 
  Population: Not Hispanic, White alone & 81.3\% & 72.1\% \\ 
  Education: High school graduate (age $>$25) & 95.8\% & 89.8\% \\ 
  People below poverty line (all ages) & 30.3\% & 12.5\% \\ 
  Population per square mile & 20.7 & 101.2 \\ 
   \bottomrule
\end{tabular}
\end{table}
