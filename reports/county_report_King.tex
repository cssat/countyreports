...
\lhead{\color{pocDGreen} King County Report}
...
\begin{tikzpicture}[x=1in, y=1in]
    ...
    \node[right = 6pt, white] at (0, \banY - \stripeYpos - \stripeHeight + 16pt)
        {\fontspec{Archer}\Huge{Focus on King County}};
    
    %% Below Stripe Text
    \node[below right = 6pt, pocDBlue, align = left, text width = \textwidth - 12pt]
        at (0, \banY - \stripeYpos - \stripeHeight) {
         This \emph{Focus on King County} report is one of a series of automated county reports for Washington State. These quarterly reports mirror the Child Well-Being Data Portal by providing information on three major parts of the child welfare system: Investigations \& Assessments, In-Home Services, and Out-of-Home Care. To access the Data Portal and the latest county reports, visit \href{http://www.partnersforourchildren.org/child-well-being}{www.partnersforourchildren.org/child-well-being}.} ;  
\end{tikzpicture}
...
\section*{Overview}
\vspace{-6pt}
The Department of Social and Health Services (DSHS) divides Washington State into three regions. King County is in Region~2, along with Island, San Juan, Skagit, Snohomish and Whatcom counties. The following report includes basic graphs and tables for Investigations \& Assessments, In-Home Services and Out-of-Home Care in King County}.
...
We hope this report serves as a valuable tool for  King County.

\begin{minipage}{0.6\textwidth}
%\vspace{-1.8in}
\textbf{Data highlights for King County:}

% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:37:00 2013
\begin{tabular}{lr}
  \toprule
 \textbf{U.S. Census Bureau (2012)} &  \\ 
  \quad Total Population & 2,007,440 \\ 
  \quad Percent of Population Under 5 Years & 6.2\% \\ 
  \quad Percent of Population Under 18 Years & 21.2\% \\ 
  \textbf{Child Well-Being Data Portal (April 01, 2013)} &  \\ 
  \quad Number of Open Investigations \& Assessments & 1,204 \\ 
  \quad Number of Open In-Home Service Cases & 217 \\ 
  \quad Number of Open Out-of-Home Care Cases & 1,431 \\ 
  \quad Percent of Out-of-Home Care Cases: Children Under 5 Years & 51\% \\ 
   \bottomrule
\end{tabular}
...
\begin{center}
\includegraphics[width=2.7in]{county_maps/King-b}
\end{center}
...
{Investigations \& Assessments:} King County Focus}
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in investigations \& assessments cases for the DCFS office(s)/office group(s) in King County.  
\begin{knitrout}
...
\subsection{\href{http://www.partnersforourchildren.org/child-well-being/visualizations/home-services/trends}
    {In-Home Services: King County Focus}
}
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in in-home services cases for the DCFS offices in King County. 
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
\subsection{\href{http://www.partnersforourchildren.org/child-well-being/visualizations/out-home-care/trends}
 {Out-of-Home Care: King County Focus}
}
...
The following bar graph shows the percentage of children in the 2010 entry cohort (those who entered at the same time in 2010) achieving each outcome for King County, Region~2 and Washington State.
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
The table below provides relevant U.S. Census Bureau data for King County and for Washington State. 
\nopagebreak[3]
% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:37:02 2013
\begin{table}[ht]
\centering
\caption{King County Summary} 
\begin{tabular}{lrr}
  \toprule
 & King County & Washington \\ 
  \midrule
Total population (2012) & 2,007,440 & 6,897,012 \\ 
  Percent change in population (2010 to 2012) & 3.9\% & 2.6\% \\ 
  Population under 5 years & 6.2\% & 6.5\% \\ 
  Population under 18 years & 21.2\% & 23.2\% \\ 
  Population: White alone & 71.9\% & 82.0\% \\ 
  Population: Black alone & 6.5\% & 3.8\% \\ 
  Population: American Indian/Alaska Native alone & 1.1\% & 1.8\% \\ 
  Population: Asian alone & 15.0\% & 7.5\% \\ 
  Population: Native Hawaiian/Other Pacific Islander alone & 0.8\% & 0.7\% \\ 
  Population: Multiracial & 4.7\% & 4.3\% \\ 
  Population: Hispanic or Latino Origin & 9.2\% & 11.6\% \\ 
  Population: Not Hispanic, White alone & 64.4\% & 72.1\% \\ 
  Education: High school graduate (age $>$25) & 91.9\% & 89.8\% \\ 
  People below poverty line (all ages) & 10.5\% & 12.5\% \\ 
  Population per square mile & 912.9 & 101.2 \\ 
   \bottomrule
\end{tabular}
\end{table}
