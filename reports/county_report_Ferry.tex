...
\lhead{\color{pocDGreen} Ferry County Report}
...
\begin{tikzpicture}[x=1in, y=1in]
    ...
    \node[right = 6pt, white] at (0, \banY - \stripeYpos - \stripeHeight + 16pt)
        {\fontspec{Archer}\Huge{Focus on Ferry County}};
    
    %% Below Stripe Text
    \node[below right = 6pt, pocDBlue, align = left, text width = \textwidth - 12pt]
        at (0, \banY - \stripeYpos - \stripeHeight) {
         This \emph{Focus on Ferry County} report is one of a series of automated county reports for Washington State. These quarterly reports mirror the Child Well-Being Data Portal by providing information on three major parts of the child welfare system: Investigations \& Assessments, In-Home Services, and Out-of-Home Care. To access the Data Portal and the latest county reports, visit \href{http://www.partnersforourchildren.org/child-well-being}{www.partnersforourchildren.org/child-well-being}.} ;  
\end{tikzpicture}
...
\section*{Overview}
\vspace{-6pt}
The Department of Social and Health Services (DSHS) divides Washington State into three regions. Ferry County is in Region~1, along with Adams, Asotin, Benton, Chelan, Columbia, Douglas, Franklin, Garfield, Grant, Kittitas, Klickitat, Lincoln, Okanogan, Pend Oreille, Spokane, Stevens, Walla Walla, Whitman and Yakima counties. The following report includes basic graphs and tables for Investigations \& Assessments, In-Home Services and Out-of-Home Care in Ferry County}.
...
We hope this report serves as a valuable tool for  Ferry County.

\begin{minipage}{0.6\textwidth}
%\vspace{-1.8in}
\textbf{Data highlights for Ferry County:}

% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:34:06 2013
\begin{tabular}{lr}
  \toprule
 \textbf{U.S. Census Bureau (2012)} &  \\ 
  \quad Total Population & 7,705 \\ 
  \quad Percent of Population Under 5 Years & 5.0\% \\ 
  \quad Percent of Population Under 18 Years & 19.6\% \\ 
  \textbf{Child Well-Being Data Portal (April 01, 2013)} &  \\ 
  \quad Number of Open Investigations \& Assessments & 0 \\ 
  \quad Number of Open In-Home Service Cases & 0 \\ 
  \quad Number of Open Out-of-Home Care Cases & 10 \\ 
  \quad Percent of Out-of-Home Care Cases: Children Under 5 Years & 40\% \\ 
   \bottomrule
\end{tabular}
...
\begin{center}
\includegraphics[width=2.7in]{county_maps/Ferry-b}
\end{center}
...
{Investigations \& Assessments:} Ferry County Focus}
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in investigations \& assessments cases for the DCFS office(s)/office group(s) in Ferry County.  
\begin{knitrout}
...
\subsection{\href{http://www.partnersforourchildren.org/child-well-being/visualizations/home-services/trends}
    {In-Home Services: Ferry County Focus}
}
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in in-home services cases for the DCFS offices in Ferry County. 
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
\subsection{\href{http://www.partnersforourchildren.org/child-well-being/visualizations/out-home-care/trends}
 {Out-of-Home Care: Ferry County Focus}
}
...
The following bar graph shows the percentage of children in the 2010 entry cohort (those who entered at the same time in 2010) achieving each outcome for Ferry County, Region~1 and Washington State.
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
The table below provides relevant U.S. Census Bureau data for Ferry County and for Washington State. 
\nopagebreak[3]
% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:34:08 2013
\begin{table}[ht]
\centering
\caption{Ferry County Summary} 
\begin{tabular}{lrr}
  \toprule
 & Ferry County & Washington \\ 
  \midrule
Total population (2012) & 7,705 & 6,897,012 \\ 
  Percent change in population (2010 to 2012) & 2.0\% & 2.6\% \\ 
  Population under 5 years & 5.0\% & 6.5\% \\ 
  Population under 18 years & 19.6\% & 23.2\% \\ 
  Population: White alone & 77.2\% & 82.0\% \\ 
  Population: Black alone & 0.5\% & 3.8\% \\ 
  Population: American Indian/Alaska Native alone & 16.5\% & 1.8\% \\ 
  ...
  Population: Hispanic or Latino Origin & 3.7\% & 11.6\% \\ 
  Population: Not Hispanic, White alone & 74.7\% & 72.1\% \\ 
  Education: High school graduate (age $>$25) & 86.1\% & 89.8\% \\ 
  People below poverty line (all ages) & 20.8\% & 12.5\% \\ 
  Population per square mile & 3.4 & 101.2 \\ 
   \bottomrule
\end{tabular}
\end{table}
