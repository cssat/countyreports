...
\lhead{\color{pocDGreen} Franklin County Report}
...
\begin{tikzpicture}[x=1in, y=1in]
    ...
    \node[right = 6pt, white] at (0, \banY - \stripeYpos - \stripeHeight + 16pt)
        {\fontspec{Archer}\Huge{Focus on Franklin County}};
    
    %% Below Stripe Text
    \node[below right = 6pt, pocDBlue, align = left, text width = \textwidth - 12pt]
        at (0, \banY - \stripeYpos - \stripeHeight) {
         This \emph{Focus on Franklin County} report is one of a series of automated county reports for Washington State. These quarterly reports mirror the Child Well-Being Data Portal by providing information on three major parts of the child welfare system: Investigations \& Assessments, In-Home Services, and Out-of-Home Care. To access the Data Portal and the latest county reports, visit \href{http://www.partnersforourchildren.org/child-well-being}{www.partnersforourchildren.org/child-well-being}.} ;  
\end{tikzpicture}
...
\section*{Overview}
\vspace{-6pt}
The Department of Social and Health Services (DSHS) divides Washington State into three regions. Franklin County is in Region~1, along with Adams, Asotin, Benton, Chelan, Columbia, Douglas, Ferry, Garfield, Grant, Kittitas, Klickitat, Lincoln, Okanogan, Pend Oreille, Spokane, Stevens, Walla Walla, Whitman and Yakima counties. The following report includes basic graphs and tables for Investigations \& Assessments, In-Home Services and Out-of-Home Care in Franklin County}.
...
We hope this report serves as a valuable tool for  Franklin County.

\begin{minipage}{0.6\textwidth}
%\vspace{-1.8in}
\textbf{Data highlights for Franklin County:}

% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:34:36 2013
\begin{tabular}{lr}
  \toprule
 \textbf{U.S. Census Bureau (2012)} &  \\ 
  \quad Total Population & 85,845 \\ 
  \quad Percent of Population Under 5 Years & 10.6\% \\ 
  \quad Percent of Population Under 18 Years & 34.1\% \\ 
  ...
  \quad Number of Open Out-of-Home Care Cases & 77 \\ 
  \quad Percent of Out-of-Home Care Cases: Children Under 5 Years & 45\% \\ 
   \bottomrule
\end{tabular}
...
\begin{center}
\includegraphics[width=2.7in]{county_maps/Franklin-b}
\end{center}
...
{Investigations \& Assessments:} Franklin County Focus}
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in investigations \& assessments cases for the DCFS office(s)/office group(s) in Franklin County.  
\begin{knitrout}
...
\subsection{\href{http://www.partnersforourchildren.org/child-well-being/visualizations/home-services/trends}
    {In-Home Services: Franklin County Focus}
}
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in in-home services cases for the DCFS offices in Franklin County. 
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
\subsection{\href{http://www.partnersforourchildren.org/child-well-being/visualizations/out-home-care/trends}
 {Out-of-Home Care: Franklin County Focus}
}
...
The following bar graph shows the percentage of children in the 2010 entry cohort (those who entered at the same time in 2010) achieving each outcome for Franklin County, Region~1 and Washington State.
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
The table below provides relevant U.S. Census Bureau data for Franklin County and for Washington State. 
\nopagebreak[3]
% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:34:38 2013
\begin{table}[ht]
\centering
\caption{Franklin County Summary} 
\begin{tabular}{lrr}
  \toprule
 & Franklin County & Washington \\ 
  \midrule
Total population (2012) & 85,845 & 6,897,012 \\ 
  Percent change in population (2010 to 2012) & 9.8\% & 2.6\% \\ 
  Population under 5 years & 10.6\% & 6.5\% \\ 
  Population under 18 years & 34.1\% & 23.2\% \\ 
  Population: White alone & 91.3\% & 82.0\% \\ 
  Population: Black alone & 2.5\% & 3.8\% \\ 
  Population: American Indian/Alaska Native alone & 1.4\% & 1.8\% \\ 
  Population: Asian alone & 2.1\% & 7.5\% \\ 
  Population: Native Hawaiian/Other Pacific Islander alone & 0.4\% & 0.7\% \\ 
  Population: Multiracial & 2.3\% & 4.3\% \\ 
  Population: Hispanic or Latino Origin & 50.5\% & 11.6\% \\ 
  Population: Not Hispanic, White alone & 43.5\% & 72.1\% \\ 
  Education: High school graduate (age $>$25) & 68.8\% & 89.8\% \\ 
  People below poverty line (all ages) & 20.9\% & 12.5\% \\ 
  Population per square mile & 62.9 & 101.2 \\ 
   \bottomrule
\end{tabular}
\end{table}
