...
\lhead{\color{pocDGreen} Lewis County Report}
...
\begin{tikzpicture}[x=1in, y=1in]
    ...
    \node[right = 6pt, white] at (0, \banY - \stripeYpos - \stripeHeight + 16pt)
        {\fontspec{Archer}\Huge{Focus on Lewis County}};
    
    %% Below Stripe Text
    \node[below right = 6pt, pocDBlue, align = left, text width = \textwidth - 12pt]
        at (0, \banY - \stripeYpos - \stripeHeight) {
         This \emph{Focus on Lewis County} report is one of a series of automated county reports for Washington State. These quarterly reports mirror the Child Well-Being Data Portal by providing information on three major parts of the child welfare system: Investigations \& Assessments, In-Home Services, and Out-of-Home Care. To access the Data Portal and the latest county reports, visit \href{http://www.partnersforourchildren.org/child-well-being}{www.partnersforourchildren.org/child-well-being}.} ;  
\end{tikzpicture}
...
\section*{Overview}
\vspace{-6pt}
The Department of Social and Health Services (DSHS) divides Washington State into three regions. Lewis County is in Region~3, along with Clallam, Clark, Cowlitz, Grays Harbor, Jefferson, Kitsap, Mason, Pacific, Pierce, Skamania, Thurston and Wahkiakum counties. The following report includes basic graphs and tables for Investigations \& Assessments, In-Home Services and Out-of-Home Care in Lewis County}.
...
We hope this report serves as a valuable tool for  Lewis County.

\begin{minipage}{0.6\textwidth}
%\vspace{-1.8in}
\textbf{Data highlights for Lewis County:}

% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:38:57 2013
\begin{tabular}{lr}
  \toprule
 \textbf{U.S. Census Bureau (2012)} &  \\ 
  \quad Total Population & 75,621 \\ 
  ...
  \quad Number of Open Investigations \& Assessments & 276 \\ 
  \quad Number of Open In-Home Service Cases & 16 \\ 
  \quad Number of Open Out-of-Home Care Cases & 120 \\ 
...
\begin{center}
\includegraphics[width=2.7in]{county_maps/Lewis-b}
\end{center}
...
{Investigations \& Assessments:} Lewis County Focus}
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in investigations \& assessments cases for the DCFS office(s)/office group(s) in Lewis County.  
\begin{knitrout}
...
\subsection{\href{http://www.partnersforourchildren.org/child-well-being/visualizations/home-services/trends}
    {In-Home Services: Lewis County Focus}
}
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in in-home services cases for the DCFS offices in Lewis County. 
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
\subsection{\href{http://www.partnersforourchildren.org/child-well-being/visualizations/out-home-care/trends}
 {Out-of-Home Care: Lewis County Focus}
}
...
The following bar graph shows the percentage of children in the 2010 entry cohort (those who entered at the same time in 2010) achieving each outcome for Lewis County, Region~3 and Washington State.
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
The table below provides relevant U.S. Census Bureau data for Lewis County and for Washington State. 
\nopagebreak[3]
% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:38:59 2013
\begin{table}[ht]
\centering
\caption{Lewis County Summary} 
\begin{tabular}{lrr}
  \toprule
 & Lewis County & Washington \\ 
  \midrule
Total population (2012) & 75,621 & 6,897,012 \\ 
  Percent change in population (2010 to 2012) & 0.2\% & 2.6\% \\ 
  Population under 5 years & 6.1\% & 6.5\% \\ 
  Population under 18 years & 22.7\% & 23.2\% \\ 
  Population: White alone & 93.4\% & 82.0\% \\ 
  Population: Black alone & 0.7\% & 3.8\% \\ 
  Population: American Indian/Alaska Native alone & 1.7\% & 1.8\% \\ 
  Population: Asian alone & 0.9\% & 7.5\% \\ 
  ...
  Population: Not Hispanic, White alone & 85.6\% & 72.1\% \\ 
  Education: High school graduate (age $>$25) & 85.6\% & 89.8\% \\ 
  People below poverty line (all ages) & 13.5\% & 12.5\% \\ 
  Population per square mile & 31.4 & 101.2 \\ 
   \bottomrule
\end{tabular}
\end{table}
