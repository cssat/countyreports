...
\lhead{\color{pocDGreen} Snohomish County Report}
...
\begin{tikzpicture}[x=1in, y=1in]
    ...
    \node[right = 6pt, white] at (0, \banY - \stripeYpos - \stripeHeight + 16pt)
        {\fontspec{Archer}\Huge{Focus on Snohomish County}};
    
    %% Below Stripe Text
    \node[below right = 6pt, pocDBlue, align = left, text width = \textwidth - 12pt]
        at (0, \banY - \stripeYpos - \stripeHeight) {
         This \emph{Focus on Snohomish County} report is one of a series of automated county reports for Washington State. These quarterly reports mirror the Child Well-Being Data Portal by providing information on three major parts of the child welfare system: Investigations \& Assessments, In-Home Services, and Out-of-Home Care. To access the Data Portal and the latest county reports, visit \href{http://www.partnersforourchildren.org/child-well-being}{www.partnersforourchildren.org/child-well-being}.} ;  
\end{tikzpicture}
...
\section*{Overview}
\vspace{-6pt}
The Department of Social and Health Services (DSHS) divides Washington State into three regions. Snohomish County is in Region~2, along with Island, King, San Juan, Skagit and Whatcom counties. The following report includes basic graphs and tables for Investigations \& Assessments, In-Home Services and Out-of-Home Care in Snohomish County}.

The Investigations \& Assessments section (page \pageref{p:ia}) and the In-Home Services section (page \pageref{p:ihs}) provide household data on, respectively, the total number of investigations and assessments and in-home service cases since 2009, as well as comparative rates for investigations and assessments and in-home service cases for all Region~2 DCFS (Division of Children \& Family Services) office(s)/office group(s) and for Washington State.
...
We hope this report serves as a valuable tool for  Snohomish County.

\begin{minipage}{0.6\textwidth}
%\vspace{-1.8in}
\textbf{Data highlights for Snohomish County:}

% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:42:21 2013
\begin{tabular}{lr}
  \toprule
 \textbf{U.S. Census Bureau (2012)} &  \\ 
  \quad Total Population & 733,036 \\ 
  \quad Percent of Population Under 5 Years & 6.5\% \\ 
  \quad Percent of Population Under 18 Years & 24.0\% \\ 
  \textbf{Child Well-Being Data Portal (April 01, 2013)} &  \\ 
  \quad Number of Open Investigations \& Assessments & 929 \\ 
  \quad Number of Open In-Home Service Cases & 58 \\ 
  \quad Number of Open Out-of-Home Care Cases & 1,154 \\ 
  \quad Percent of Out-of-Home Care Cases: Children Under 5 Years & 55\% \\ 
   \bottomrule
\end{tabular}
...
\begin{center}
\includegraphics[width=2.7in]{county_maps/Snohomish-b}
\end{center}
...
{Investigations \& Assessments:} Snohomish County Focus}
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in investigations \& assessments cases for the DCFS office(s)/office group(s) in Snohomish County.  
\begin{knitrout}
...
\subsection{\href{http://www.partnersforourchildren.org/child-well-being/visualizations/home-services/trends}
    {In-Home Services: Snohomish County Focus}
}
The following graph(s) display point-in-time (i.e., first day of the quarter) trends in in-home services cases for the DCFS offices in Snohomish County. 
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
\begin{minipage}{\textwidth}
\subsection{\href{http://www.partnersforourchildren.org/child-well-being/visualizations/out-home-care/trends}
    {Out-of-Home Care: Region~2}
}
To give context to the Snohomish County trend data, the following plot shows the rate of out-of-home care in quarter 2 of 2013 for Region~2 counties and for Washington State. Rates, rather than counts (or total numbers), are used because they account for the population differences across Washington State counties.\\[1pt]
%\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
Table 2 identifies the percentage of children re-entering out-of-home care within two years of exiting to a permanent outcome in 2010, by permanency type, for Region~2 counties, as well as for Washington State overall. The higher percentages of re-entry point to the challenges of providing a safe, permanent outcome for the child.
\vspace{12pt}
\nopagebreak[3]
% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:42:23 2013
\begin{table}[ht]
\centering
...
The following bar graph shows the percentage of children in the 2010 entry cohort (those who entered at the same time in 2010) achieving each outcome for Snohomish County, Region~2 and Washington State.
\nopagebreak[3]
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
Assuming that to some extent kinship care measures child's well-being in an out-of-home setting, the graph below shows the average percent of time that children in out-of-home care spend in kinship care (as opposed to foster care or a non-family setting) for the counties in Region~2. While in out-of-home care, children often stay in different settings. For example, a child can start in a foster home, but then move to kinship care as soon as a willing and able relative is identified. The online Data Portal provides a more detailed look at kinship care, as well as several other measures related to child well-being.
...
The table below provides relevant U.S. Census Bureau data for Snohomish County and for Washington State. 
\nopagebreak[3]
% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Thu Nov 14 16:42:23 2013
\begin{table}[ht]
\centering
\caption{Snohomish County Summary} 
\begin{tabular}{lrr}
  \toprule
 & Snohomish County & Washington \\ 
  \midrule
Total population (2012) & 733,036 & 6,897,012 \\ 
  Percent change in population (2010 to 2012) & 2.8\% & 2.6\% \\ 
  Population under 5 years & 6.5\% & 6.5\% \\ 
  Population under 18 years & 24.0\% & 23.2\% \\ 
  Population: White alone & 81.7\% & 82.0\% \\ 
  Population: Black alone & 2.8\% & 3.8\% \\ 
  Population: American Indian/Alaska Native alone & 1.6\% & 1.8\% \\ 
  Population: Asian alone & 9.2\% & 7.5\% \\ 
  Population: Native Hawaiian/Other Pacific Islander alone & 0.5\% & 0.7\% \\ 
  Population: Multiracial & 4.2\% & 4.3\% \\ 
  Population: Hispanic or Latino Origin & 9.2\% & 11.6\% \\ 
  Population: Not Hispanic, White alone & 73.9\% & 72.1\% \\ 
  Education: High school graduate (age $>$25) & 91.0\% & 89.8\% \\ 
  People below poverty line (all ages) & 9.3\% & 12.5\% \\ 
  Population per square mile & 341.8 & 101.2 \\ 
   \bottomrule
\end{tabular}
\end{table}
